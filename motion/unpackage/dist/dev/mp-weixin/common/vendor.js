...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"motion","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
var _default = {
  "pages": [{
    ...
    "path": "pages/match/medalWall",
    "style": {
      "navigationBarTitleText": "勋章墙"
    }
  }, {
    "path": "pages/match/matchDetail",
    "style": {
...
Mock.mock('home/hotActivity', {
  ...
  'project|5-20': [{
    ...
    //时间
    read: '@integer(1,10000)',
    //阅读量
    enlist: '@natural()',
    //报名参赛
    details: '@cparagraph(5, 30)',
    //详情
    mode: '@boolean()',
    //参赛方式
    'raise|1': ["未开始", "报名中", "已结束"],
...
Mock.mock('multiple/detail', {
  ...
  //图片
  name: '@cname',
  title: '@date(yyyy)' + '年' + '@ctitle(3, 20)',
  //标题
  subTitle: '@ctitle(5)' + '.' + '@ctitle( 5)',
  'raise|1': ["未开始", "报名中", "已结束"],
  //募集

  signTime: "@datetime(yyyy-MM-dd HH:mm)" + '至' + "@datetime(yyyy-MM-dd HH:mm)",
  //时间
  competeTime: "@datetime(yyyy-MM-dd HH:mm)" + '至' + "@datetime(yyyy-MM-dd HH:mm)",
  //时间
  line: '@city(true)' + '路线',
  //线路
  'level|1': ['A', 'B', 'C'] //难度
...
Mock.mock('multiple/roster/list', {
  'list|3-30': [{
    ...
    'id|+1': 20221101,
    name: '@cname',
    signTime: "@datetime(yyyy-MM-dd HH:mm)",
    //时间
    'team|1': ["单人", "双人", "三人", "团队"],
    //个人，双人，三人 ，tram>3=团队，
    'signType|1': ["预赛", "复赛", "半决赛", "决赛"]
  }]
});
...
exports.default = void 0;
var baseURL = "http://10.20.66.156:8080"; //公共路径 
